...
\newcommand*{\Title}            {Bestimmung der Ersatzparameter eines Kabels}
\newcommand*{\TitleInfo}        {Testat HS 25/26}
\newcommand*{\AuthorOne}		{Laurens Perseus}
\newcommand*{\AuthorTwo}		{Gian Marco Näf}
\newcommand*{\Author}			{\AuthorOne, \AuthorTwo}
\newcommand*{\Prof}				{Dr. Jasmin Smajic}
\newcommand*{\Modul}			{Angewandter Elektromagnetismus: Felder und Wellen}
\newcommand*{\Betreuer}			{Urs Fischli}
\newcommand*{\Place}            {Rapperswil}
\newcommand*{\LogoHSR}          {\includegraphics[height = 1cm]{images/logo_ost.pdf}}
