...
\author{Studiengang Elektrotechnik \\ Modul: Angewandter \\ Verfasser: Laurens Perseus, Gian Marco Näf}
\date{\today}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{images/magnetic_flux_density.png}
    \caption{Magnetische Flussdichte und Stromverteilung der Leiter bei $f=\SI{50}{Hz}$.}
...
Hier Grafiken und Kapazitätsmatrix einfügen:

\begin{table}[H]
\centering
\begin{tabular}{c|c}
\textbf{Kapazität} & \textbf{Wert} \\
\hline
$C_{11}$ & ... \\
$C_{12}$ & ... \\
$C_{13}$ & ... \\
$C_{1\text{Schirm}}$ & ... \\
\end{tabular}
\caption{Kapazitive Kopplungen der Leiter und gegen die Abschirmung.}
\end{table}
